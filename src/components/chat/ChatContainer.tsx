...
const containerClasses = {
  ...
  faq: 'max-w-[300px] md:max-w-[400px] faq-item border border-gray-300 font-5medium w-fit mt-[10px] rounded-[20px] px-[20px] py-[15px] max-w-[400px] break-words inline-block hover:bg-gray-100 transition-colors mr-[10px] cursor-pointer',
};
